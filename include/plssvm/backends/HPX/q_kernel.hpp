 ...
 *
 * @brief Defines HPX functions for generating the `q` vector.
 */

#ifndef PLSSVM_BACKENDS_HPX_Q_KERNEL_HPP_
#define PLSSVM_BACKENDS_HPX_Q_KERNEL_HPP_
#pragma once
...
#endif  // PLSSVM_BACKENDS_HPX_Q_KERNEL_HPP_