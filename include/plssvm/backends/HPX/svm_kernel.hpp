 ...
 *
 * @brief Defines the kernel functions for the C-SVM using the HPX backend.
 */

#ifndef PLSSVM_BACKENDS_HPX_SVM_KERNEL_HPP_
#define PLSSVM_BACKENDS_HPX_SVM_KERNEL_HPP_
#pragma once
...
#endif  // PLSSVM_BACKENDS_HPX_SVM_KERNEL_HPP_